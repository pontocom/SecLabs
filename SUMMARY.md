...
* [Vulnerability Exploitation](vulnexploit/README.md)
  ...
  * [Exploitation with Metasploit Framework](vulnexploit/exploitation.md)
    ...
    * [UnrealIRCd backdoor [CVE-2010-2075]](vulnexploit/exploits/unreal.md)
    * [distCC RCE [CVE-2004-2687]](vulnexploit/exploits/distcc.md)
    * [Java RMI Server Insecure Default Configuration RCE Vulnerability](vulnexploit/exploits/javarmi.md)
    * [VNC Brute Force Login](vulnexploit/exploits/vnc.md)
    * [MySQL / MariaDB Default Credentials (MySQL Protocol)](vulnexploit/exploits/mysql.md)
    * [SAMBA (Samba “username map script” Command Execution)](vulnexploit/exploits/samba.md)
    * [Tomcat (Apache Tomcat Manager Application Deployer Authenticated Code Execution)](vulnexploit/exploits/tomcat.md)
    * [Apache (CGI Argument Injection)](vulnexploit/exploits/apache.md)
    * [Windows Eternalblue [CVE-2017-143,144,145,146,148]](vulnexploit/exploits/eternalblue.md)
